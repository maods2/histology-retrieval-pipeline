...
# Bracs Efficientnet Finetune

python ./embedding_encoder/src/main.py --pipeline=train --config-file=embedding_encoder/config/bracs_efficient_finetune/train_autoencoder_efficientnet.toml
python ./embedding_encoder/src/main.py --pipeline=train --config-file=embedding_encoder/config/bracs_efficient_finetune/train_swav_efficientnet.toml
python ./embedding_encoder/src/main.py --pipeline=train --config-file=embedding_encoder/config/bracs_efficient_finetune/train_triplet_efficientnet.toml